...
- Puppeteer is installed locally in the project (`npm install puppeteer` was run in the project root; no separate global path needed).
...
- Do not use em dashes (—) anywhere in `index.html`, including code comments and user-facing text. Use a comma, period, or colon instead.
